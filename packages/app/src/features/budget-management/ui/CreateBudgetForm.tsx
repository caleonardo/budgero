...
const CreateBudgetForm: React.FC<CreateBudgetFormProps> = ({
  ...
  return (
    <div className="space-y-3 sm:space-y-4 text-sm sm:text-base max-h-[min(92vh,calc(100dvh-2rem))] overflow-y-auto sm:max-h-[min(85vh,calc(100dvh-6rem))] px-1 sm:px-0">
      <Tabs
        value={tab}
