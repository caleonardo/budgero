...
export default async function OgImage({
  ...
  const logoData = await fetch(new URL('../../../public/logo_512.png', import.meta.url)).then(
    (res) => res.arrayBuffer()
  );
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        >
          {' '}
          {t('private_budgeting_without_bank_connections')}{' '}
        </div>
        <div
          style={{
            fontSize: 26,
        ...
        >
          {' '}
          {t('zero_knowledge_encryption_168_currencies_35')}{' '}
        </div>
      </div>
