...
<Callout title="Budgero unterstützen">
  <p className="!my-0">Self-Hosting ist kostenlos und Spenden sind freiwillig. Wenn Budgero dir hilft, unterstütze die Entwicklung mit einer <TrackedLink href="/donate" event="Self-Host - Donate (Setup Guide)" className="underline underline-offset-4">einmaligen Spende</TrackedLink>.</p>
</Callout>
