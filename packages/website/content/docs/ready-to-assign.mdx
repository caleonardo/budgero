...
- Money **assigned in future months** is already spoken for, so it is deducted from the month you are viewing (shown as "Assigned in future months" in the Ready to Assign breakdown). Like YNAB, this can only bring an earlier month down to zero — if you assign more ahead than you have, the shortfall shows as negative Ready to Assign in the month where you assigned it.
