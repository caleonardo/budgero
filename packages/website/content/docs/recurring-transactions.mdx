...
- **Ends** — never, on a date, or after a set number of occurrences (counted from the first one, including any you posted or skipped). Handy for loans, instalment plans, and fixed-term subscriptions.
