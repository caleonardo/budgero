...
<Callout title="Apoya a Budgero">
  <p className="!my-0">El autoalojamiento es gratuito y las donaciones son opcionales. Si Budgero te resulta útil, <TrackedLink href="/donate" event="Self-Host - Donate (Setup Guide)" className="underline underline-offset-4">haz una donación puntual</TrackedLink> para apoyar el desarrollo.</p>
</Callout>
