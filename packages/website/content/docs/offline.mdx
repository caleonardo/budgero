...
- **Fetched exchange rates.** Live rate lookups need the network. If you budget across currencies and travel, set **manual rates** for the currencies you use (see [Accounts](/docs/accounts)) — manual rates work entirely offline. When no rate is cached, Budgero prompts you with the closest cached rate prefilled, and by default trues conversions up to official rates automatically once you reconnect.
